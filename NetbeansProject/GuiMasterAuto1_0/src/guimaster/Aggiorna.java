 ...
 * @author antoninom
 */
public class Aggiorna extends javax.swing.JInternalFrame {
    ...
    private void btnCercaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCercaActionPerformed
        ...
        if(find>(list.size()-1))
        {
            JOptionPane.showMessageDialog(this, "Elemento non esistente");
        }else{
    ...
    private void btnAggiornaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAggiornaActionPerformed
        ...
        list.get(find).setMarca(txtMarca.getText());
        list.get(find).setModello(txtModello.getText());
        list.get(find).setColore(txtColore.getText());
        list.get(find).setCilindrata(Integer.parseInt(txtCilindrata.getText()));
        list.get(find).setAlimentazione((Alimentazione) cmbAlimentazione.getSelectedItem());
       
        MyLibrary.create(fileName,list);
        JOptionPane.showMessageDialog(this, "Elemento aggiornato");
