 ...
 * @author antoninom
 */
public class FinestraAnag extends javax.swing.JFrame {

    /**
     * Creates new form FinestraAnag
     */
    public FinestraAnag() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FinestraAnag.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FinestraAnag().setVisible(true);
            }
        });
    }
