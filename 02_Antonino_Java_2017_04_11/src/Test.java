...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println("Stampa elenco meccanici: "+m1+"\n"+m2); // nel caso di più meccanici si potrebbe creare un ArrayList apposito per gestirne la stampa
		...
		//codice più facile.
		//Inoltre, se fossi più veloce nel scrivere il codice, nella classe test avrei implementato uno switch per permettere una gestione migliore 
		//del tutto
